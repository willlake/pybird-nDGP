...
from pybirdnDGP.fftlog import FFTLog, MPC
from pybirdnDGP.common import co
...
class Projection(object):
    ...
    def get_AP_param(self, bird=None, DA=None, H=None):
        ...
        """
        if bird is not None: 
            if bird.with_shapefit:
                qpar, qperp = bird.alpha_par, bird.alpha_perp
            else:
                qpar, qperp = self.H_fid / bird.H, bird.DA / self.D_fid
